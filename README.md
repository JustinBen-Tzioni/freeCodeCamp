...
freeCodeCamp.org is a friendly community where anyone can learn to code for free. It is a [donor-supported 501(c)(3) nonprofit](https://donate.freecodecamp.org) with the goal of helping millions of busy adults transition into tech. The freeCodeCamp community has already helped more than 10,000 people get their first developer job.
