...
When working with CSS you will likely run into browser compatibility issues at some point. So it's important to provide browser fallbacks to avoid potential problems.
